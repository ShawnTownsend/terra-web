      ...
      <>
         <body className="signUp">
            <container className="container">
               <Header2 />
               <img
                  src="https://i.imgur.com/Gc8FnHC.png"
                  alt="fruits"
                  id="fruits"
                  height="500px"
               />
               ...
               <button className="GF">Continue with Google</button>
               <button className="GF" id="GFF">
                  Continue with Facebook
               </button>
               <h5 id="pTag">Have an account?</h5>
               <a href="/signin" id="aTag">
                  Sign In
               </a>
            </container>
         </body>

...
function FrontPage() {
        return(
          ...
          <img src='https://i.imgur.com/pt89UKR.png' alt='Coin in hand' id="secondImage"/> 
          <img src="https://i.imgur.com/eYZ2JPj.png" alt='Girl pointing' id="thirdImage"/>
          <h2 id="fifthQ">Compete with other Terrarians and be featured.</h2>
          <button>
            Join Now
          </button>
          <p>Have an account?</p><a href="/signin">Sign In</a>
          </container>
          </body>
        </>
        )
